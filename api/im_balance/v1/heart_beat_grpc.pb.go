...
func (c *heartBeatServiceClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
	err := c.cc.Invoke(ctx, "/im_balance.api.v1.HeartBeatService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeartBeatService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/im_balance.api.v1.HeartBeatService/Ping",
	}
...
var HeartBeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "im_balance.api.v1.HeartBeatService",
